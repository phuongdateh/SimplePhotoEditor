...
class CropRectView: UIView,
    ...
    fileprivate func initialize() {
        ...
        resizeImageView.image = UIImage(named: "PhotoCropEditorBorder")?.resizableImage(withCapInsets: UIEdgeInsets(top: 23.0, left: 23.0, bottom: 23.0, right: 23.0))
